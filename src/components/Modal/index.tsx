...
export const CardModal: React.FC<CardModalProps> = ({
  ...
  const handleChecklistItemKeyPress = (
      ...
      <ModalContent $wide={selectedImage !== null}>
        {selectedImage ? (
          ...
          <>
            ...
            <Tabs>
              <TabList>
                <Tab $isActive={activeTab === "main"} onClick={() => setActiveTab("main")}>
                  Основное
                </Tab>
                <Tab $isActive={activeTab === "images"} onClick={() => setActiveTab("images")}>
              ...
              <TabPanel $isActive={activeTab === "images"}>
                ...
                <ImageGallery>
                  ...
                  {images.length === 0 && <NoImages>Нет загруженных изображений</NoImages>}
                </ImageGallery>
              </TabPanel>
              ...
              <TabPanel $isActive={activeTab === "checklists"}>
                {checklists.map((checklist) => (
                  <ChecklistContainer key={checklist.id}>
                    ...
                    {!isViewMode && (
                      <DeleteButton type="button" onClick={() => handleDeleteChecklist(checklist.id)}>
                        Удалить
                      </DeleteButton>
                    )}
                ...
                <HistoryList>
                  {history.map((record) => (
                    <HistoryItem key={record.id}>
                      ...
                      <HistoryTime>{new Date(record.timestamp).toLocaleString()}</HistoryTime>
                    </HistoryItem>
                  ))}
